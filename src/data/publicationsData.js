// Auto-generated from publications.json using scripts/update_publications_js.py
export const publicationsData = [
  {
    "id": 1,
    "title": "Multi-class fruit-on-plant detection for apple in SNAP system using Faster R-CNN",
    "authors": "Fangfang Gao and Longsheng Fu and Xin Zhang and Yaqoob Majeed and Rui Li and Manoj Karkee and Qin Zhang",
  ...
  {
    "id": 2,
    "title": "Renewable energy as an alternative source for energy management in agriculture",
  ...
  },
  {
    ...
    "authors": "Longsheng Fu and Yaqoob Majeed and Xin Zhang and Manoj Karkee and Qin Zhang",
  ...
  },
  {
    ...
    "authors": "Longsheng Fu and Yali Feng and Jingzhu Wu and Zhihao Liu and Fangfang Gao and Yaqoob Majeed and Ahmad Al-Mallahi and Qin Zhang and Rui Li and Yongjie Cui",
  ...
  },
  {
    ...
    "authors": "Longsheng Fu and Yali Feng and Yaqoob Majeed and Xin Zhang and Jing Zhang and Manoj Karkee and Qin Zhang",
  ...
  },
  {
    ...
    "authors": "Jing Zhang and Manoj Karkee and Qin Zhang and Xin Zhang and Majeed Yaqoob and Longsheng Fu and Shumao Wang",
    "journal": "Computers and Electronics in Agriculture",
    "year": 2020,
  ...
  {
    "id": 12,
    "title": "Printing the future of food: The physics perspective on 3D food printing",
  ...
  {
    "id": 14,
    "title": "Determining grapevine cordon shape for automated green shoot thinning using semantic segmentation-based deep learning networks",
  ...
  },
  {
    ...
    "journal": "Computers and Electronics in Agriculture",
    "year": 2022,
    "abstract": "Apple tree phenotyping can reflect individual development of single apple tree, which mainly involves tree height, crown width, and diameter of apple tree trunk (DATT). This study aimed to estimate diameter of grafted apple tree trunk, whose target position of diameter estimation is about 10 cm above grafting position. An estimated DATT approach of combining red–greenblue-depth (RGB-D) sensor with SOLOv2 was proposed. Firstly, Kinect V2 was employed to obtain original RGB images and point clouds of the grafted apple trees simultaneously. There were 120 and 60 RGB images and corresponding point clouds randomly collected from two modern apple orchards. Secondly, SOLOv2 deep learning model was selected and trained to instance segment grafting position from RGB image for determining it automatically. Then, corresponding exact position of the grafting position in point cloud was mapped by …",
    "citations": 37,
  ...
  },
  {
    ...
    "authors": "Changqing Gao and Hanhui Jiang and Xiaojuan Liu and Haihong Li and Zhenchao Wu and Xiaoming Sun and Leilei He and Wulan Mao and Yaqoob Majeed and Rui Li and Longsheng Fu",
    "journal": "Computers and Electronics in Agriculture",
    "year": 2024,
    "abstract": "Localization is the first critical step for picking robots to successfully grasp fruit. However, classical binocular localization methods adopted global matching for kiwifruit, which may result in a large amount of mismatching feature points in complex orchard and thus cause low localization accuracy. Therefore, an improved binocular localization method of calyxes based on deep learning was proposed to accurately detect and locate kiwifruit for robotic harvesting. Calyxes in the binocular images and kiwifruit in the left images of the binocular images were detected using You Only Look Once version 5 xlarge (YOLOv5x). The detected calyxes were matched in the binocular images using kiwifruit and calyx pairing and kiwifruit matching. The matched calyxes in the binocular images were used to locate calyxes using three localization methods. Specifically, three binocular localization methods, i.e., calyx localization (CL …",
    "citations": 28,
    "url": "https://www.sciencedirect.com/science/article/pii/S0168169924000127"
  },
  {
    "id": 23,
    "title": "Automated execution of a pest bird deterrence system using a programmable unmanned aerial vehicle (UAV)",
    "authors": "Santosh Bhusal and Manoj Karkee and Uddhav Bhattarai and Yaqoob Majeed and Qin Zhang",
    "journal": "Computers and Electronics in Agriculture",
    "year": 2022,
  ...
  },
  {
    ...
    "journal": "IFAC-PapersOnLine",
    "year": 2018,
    "abstract": "Advanced electronic technology makes mobile phone suitable for image processing technology on fruit yield estimation. A new method was proposed to estimate yield of kiwifruit orchard via image processing using an Android mobile phone. Image processing was used to select significant color channels and their threshold for segmentation, generate binarized image, and remove noise. A fruit-counting algorithm was developed to calculate the number of kiwifruit by identifying the number of fruit calyxes. Image area was estimated by the pixels proportion of a reference board hung under the canopy. Finally, yield was calculated by multiplying the proportion of the image in three-dimensional space with the number of kiwifruit in an image and the kiwifruit orchard area. Under natural conditions, the performance of the fruit counting algorithm software was validated with 100 kiwifruit images. The proposed method …",
    "citations": 26,
  ...
  {
    "id": 31,
    "title": "Artificial intelligence-of-things (AIoT) in precision agriculture",
  ...
  },
  {
    ...
    "authors": "Rui Suo and Longsheng Fu and Leilei He and Guo Li and Yaqoob Majeed and Xiaojuan Liu and Guanao Zhao and Ruizhe Yang and Rui Li",
    "journal": "Computers and Electronics in Agriculture",
    "year": 2022,
  ...
  },
  {
    ...
    "authors": "Liguo Jiang and Hanhui Jiang and Xudong Jing and Haojie Dang and Rui Li and Jinyong Chen and Yaqoob Majeed and Ramesh Sahni and Longsheng Fu",
  ...
  },
  {
    ...
    "year": 2022,
    "abstract": "Climate change is bringing an inevitable change to planet earth. One of the recent victims of climate change is Pakistan, in the form of a disastrous ood that leads to severe food insecurity throughout the country. Recent food insecurity results from damage done by the ood to agricultural land, which have an extreme effect on districts marked by highly malnourished populations.",
    "citations": 5,
  ...
  },
  {
    ...
    "year": 2023,
    "abstract": "This chapter will discuss the opportunities and challenges of robotic solutions for tree fruit production with modern planar tree canopy management, including the importance of modern tree canopy system, robot-canopy interaction, robotic system control, in-field sensing for object detection, and three-dimensional (3D) reconstruction, and a case study on the robotic branch pruning for apples with modern tree canopies. In the end, the conclusion and future directions were investigated.",
    "citations": 0,
  ...
  },
  {
    ...
    "year": 2018,
    "abstract": "This dataset contains the vineyard canopy images captured during early growth stages of green shoots",
    "citations": 0,
  ...
  },
  {
    ...
    "abstract": "Node recognition is crucial for precision grapevine winter pruning by robots. However, deep learning models cannot fully recognize all nodes, which may lead to incorrect identification of pruning positions, resulting in destructive pruning. Therefore, a node re-recognition method based on homography transformation is proposed to improve the identification accuracy of pruning positions. Firstly, canopy images captured from three different views were instance segmented using YOLO11l-seg. Nodes that were not instance segmented in the middle image (target image) were instance segmented in both side images (reference image). Subsequently, node positions from reference images to target image were estimated using homography transformation derived from the homography matrices of canes containing the nodes. These matrices were computed based on the key points of canes, which detected and matched by SuperPoint and SuperGlue networks. Results showed that YOLO11l-seg achieved best segmentation performance with mAP of 88.9% in grapevine instance segmentation. Compared to the translation transformation, the homography transformation-based method reduced an average node position offset by 10.8 pixels and achieved a higher re-recognition success rate of 84.3%. The pruning positions identification accuracy was improved from 87.5% to 94.1% by using the node re-recognition method. These results indicate that the proposed node re-recognition method is promising for robotic winter pruning of grapevine.",
    "citations": 0,
  ...
  },
  {
    ...
    "abstract": "Grid-distributed wires in T-trellis kiwifruit orchards support dense canopies and enable mechanized operations such as robotic harvesting. However, these wires pose a risk of damaging the robot’s end-effector, especially when target fruits are partially hidden behind thin wire obstructions. Accurate wire identification is therefore essential for optimizing picking strategies. This study employed YOLO11x-seg instance segmentation network to segment grid-distributed wires, which are challenging to identify due to low visibility compared to fruits, branches, and leaves. To enhance wire identification, a Geometric Feature Grouping-connection (GFG) approach was proposed. This approach leveraged direction classification, spatial clustering, and boundary extension to effectively group and connect discrete wire segments with similar geometric features, enabling complete and continuous reconstruction of grid-distributed wires. YOLO11x-seg was trained on both the original and overlap-partitioned datasets, but tested on separate images requiring stitching. Results demonstrated that the model attained an improved average precision of 28.50% at an IoU of 0.5 on the overlap-partitioned dataset, representing a 13.50% increase compared to the original dataset. With image overlap-partitioning and stitching (IOS), YOLO11x-seg reached IoU and PA of 21.19% and 21.00%, showing respective improvements of 9.54% and 10.00% compared to results without IOS. Moreover, GFG approach achieved a reconstruction accuracy of 78.28% for grid-distributed wires. These findings indicate that the proposed GFG approach enables accurate reconstruction of grid …",
    "citations": 0,
  ...
  },
  {
    ...
    "authors": "Yaqoob Majeed and Manoj Karkee and Qin Zhang",
    "citations": 0,
    "url": "https://rex.libraries.wsu.edu/esploro/outputs/dataset/Vineyard-Canopy-Images-during-Early-Growth/99900501614101842?institution=01ALLIANCE_WSU"
  }
];
