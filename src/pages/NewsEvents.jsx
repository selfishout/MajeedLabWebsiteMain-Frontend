...
import { newsEventsData, newsEventsHelper } from '../data/newsEventsData';
...
export default function NewsEvents() {
  ...
  useEffect(() => {
    ...
    const allNews = newsEventsHelper.getAllNews();
    const allEvents = newsEventsHelper.getAllEvents();
    setNews(allNews);
    setEvents(allEvents);
  }, []);
  ...
  const getUpcomingEvents = () => {
    return newsEventsHelper.getUpcomingEvents();
  };
